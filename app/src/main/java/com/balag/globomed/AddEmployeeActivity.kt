...
import java.util.*
import com.balag.globomed.GloboMedDbContract.EmployeeEntry as EmployeeEntry
...
class AddEmployeeActivity : Activity() {
    ...
    private fun saveEmployee() {
        ...
        if(isValid) {
            ...
            val result:Long = db.insert(EmployeeEntry.TABLE_NAME,null,values)

            setResult(RESULT_OK, Intent())
            Toast.makeText(applicationContext,"Employee added successfully",Toast.LENGTH_SHORT).show()
        }
        finish()
    }
